            ...
            <div class="row g-0">
               ...
               <div class="col-md-7 login-right d-flex flex-column justify-content-center">
                  <div class="d-md-none text-center mb-4">
                     ...
                     <h2 class="mt-3 text-dark">Harvest Hub</h2>
                  </div>
                  <h2 class="text-dark mb-2" style="font-size: 2.2rem;">Welcome Back 👋</h2>
...
<body>
   ...
   <div class="main-content" id="mainContent">
            ...
            <div class="card-body-custom">
               <?php if (($user_details['role'] ?? '') === 'farmer'): ?>
                  ...
                  <div id="addProdForm" class="form-container" style="display:none;">
                     <h6 class="mb-4 text-dark border-bottom pb-3">Add Product for
      ...
      <?php elseif ($table == 'sales_report'): ?>
         ...
         <div class="row g-4 mb-4">
            <div class="col-md-6">
               <div class="content-card h-100 mb-0">
                  <div class="card-header-custom border-0 pb-0">
                     <h5><i class="fas fa-crown text-warning me-2"></i>Top Products</h5>
                  </div>
            ...
            <div class="col-md-6">
               <div class="content-card h-100 mb-0">
                  <div class="card-header-custom border-0 pb-0">
                     <h5><i class="fas fa-star text-primary me-2"></i>Top Customers</h5>
                  </div>
                  <div class="card-body-custom pt-3">
         ...
         <div class="content-card">
            <div class="card-header-custom">
               <h5><i class="fas fa-calendar-alt text-info me-2"></i>Monthly Revenue</h5>
            </div>
      ...
      <?php elseif ($table == 'purchases'): ?>
         ...
         <div class="content-card">
            <div class="card-header-custom">
               <h5><i class="fas fa-users me-2 text-primary"></i>All Consumers</h5>
            </div>
            <div class="card-body-custom">
            ...
            <div class="card-body-custom p-0">
               <?php if ($table != 'sales_report' && $table != 'bids'): ?>
                  <div id="addForm" class="form-container m-4" style="display:none;">
                     <h6 class="mb-4 border-bottom border-light pb-3">Create New
      ...
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content border-0 shadow-lg" style="border-radius: 24px;">
            <div class="modal-header border-bottom border-light p-4"
               ...
               <h5 class="modal-title text-dark"><i class="fas fa-sync-alt me-2 text-primary"></i>Update Order
                  Status</h5>

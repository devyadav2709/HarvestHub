...
echo "<link href='https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Changa+One&display=swap' rel='stylesheet'>";
echo "<style>h1,h2,h3,h4,h5,h6{font-family:'Changa One',sans-serif;font-weight:400;}</style>";
echo "<div style='font-family: \"Inter\", sans-serif; padding: 40px; text-align: center; background: #f4f4f4; border: 1px solid #ddd; margin: 20px;'>";
